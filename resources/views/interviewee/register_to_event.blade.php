...
@section('content')
    ...
    <div class="grid grid-cols-8 mx-12 rounded-xl shadow-lg mb-3" style="background-color:rgb(56,4,140)">
        ...
        <div class="col-span-2 flex justify-end items-center">
            <button class="text-black font-bold py-5 px-16 rounded-xl shadow-lg text-4xl" style="background-color:rgb(248,148,44)" onclick="window.location.href='{{ route('registration_form') }}'">Daftar</button>
        </div>
    </div>
    <div class="grid grid-cols-8 mx-12 rounded-xl shadow-lg mb-3" style="background-color:rgb(56,4,140)">
        <div class="col-span-4 text-left py-6 pl-4 font-bold text-white text-2xl">
