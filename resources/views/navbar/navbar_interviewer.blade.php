...
<nav class="bg-gray-300 dark:bg-black">
    ...
    <div class="relative flex h-16 items-center justify-between bg-gray-300 dark:bg-black">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        <div class="flex flex-shrink-0 items-center">
          <img class="h-8 w-auto" src="{{ asset('storage/logo-navbar.png') }}" alt="Your Company">
        </div>
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <a href="{{ route('add_event') }}" class="@if(Request::is('add_event')) activeNavbarInterviewer @endif montserratSemiBold rounded-md  px-3 py-2 text-sm font-medium text-black dark:text-white hover:opacity-50" aria-current="page">Add Event</a>
            <a href="{{ route('manage_interview') }}" class="@if(Request::is('manage_interview')) activeNavbarInterviewer @endif montserratSemiBold rounded-md px-3 py-2 text-sm font-medium text-black dark:text-white hover:opacity-50">Manage Interview</a>
  ...
  <div class="hidden" id="mobile-menu">
    <div class="space-y-1 px-2 pb-3 pt-2">
      <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
      <a href="{{ route('add_event') }}" class="@if(Request::is('add_event')) activeNavbar @endif montserratSemiBold block rounded-md px-3 py-2 text-base font-medium text-black dark:text-white " aria-current="page">Add Event</a>
      <a href="{{ route('manage_interview') }}" class="@if(Request::is('manage_interview')) activeNavbar @endif montserratSemiBold block rounded-md px-3 py-2 text-base font-medium text-black hover:bg-gray-700 hover:text-white dark:text-white">Manage Interview</a>
