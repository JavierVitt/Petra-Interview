            ...
            <form action="{{ route('login') }}" method="post" class="bg-white shadow-md rounded px-8 pt-6 pb-6">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="email" value="{{ old('email') }}" type="text" placeholder="Email address" required name="email"
                        autocomplete="off">
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input
                        ...
                        id="password" type="password" value="{{ old('password') }}" placeholder="******************" required name="password">
