...
<?php $__env->startSection('content'); ?>
    ...
    <div class="grid grid-cols-6 text-center mx-12 border-b-2 mt-4 border-gray-100 text-lg">
        <div class="col-span-1 font-bold text-3xl mx-3 mb-2">1.</div>
...
<?php echo $__env->make('templates.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\UASWebFrame\UAS\resources\views/question.blade.php ENDPATH**/ ?>